...
def parse_args():
  ...
  parser.add_argument(
    ...
    type=str,
    default=None,
    const='xfeat_raw.onnx',
    help="Export XFeat raw model with given filename.",
  )
  parser.add_argument(
    "--xfeat",
    nargs='?',
    ...
    default=None,
    const='xfeat.onnx',
    help="Export xfeat model with given filename.",
  )
  parser.add_argument(
    "--xfeat_match",
    nargs='?',
    type=str,
    default=None,
    const='xfeat_match.onnx',
    help="Export xfeat match model with given filename.",
  )
  parser.add_argument(
    "--xfeat_lighterglue",
    nargs='?',
    type=str,
    default=None,
    const='xfeat_lighterglue.onnx',
    help="Export LighterGlue match model with given filename.",
  )
  parser.add_argument(
    "--xfeat_star",
    nargs='?',
    type=str,
    default=None,
    const='xfeat_star.onnx',
    help="Export xfeat star model with given filename.",
  )
  parser.add_argument(
    "--xfeat_star_match",
    nargs='?',
  ...
  parser.add_argument(
    ...
    type=str,
    default=None,
    const='xfeat_star_aio.onnx',
    help="Export xfeat star All in One.",
  )
  parser.add_argument(
    "--split_instance_norm",
    action="store_true",
...
if __name__ == "__main__":
  ...
  if args.xfeat_raw:
    ...
    model_files.append(args.xfeat_raw)
  ...
  if args.xfeat_match:
    ...
    model_files.append(args.xfeat_match)

  # if args.xfeat_only_model_match_lighterglue:
  ...
  if args.xfeat_star:
    ...
    model_files.append(args.xfeat_star)

  if args.xfeat_star_match:
    ...
    model_files.append(args.xfeat_star_match)

  if args.xfeat_star_aio:
    ...
    model_files.append(args.xfeat_star_aio)

  for model in model_files:
    model_onnx = onnx.load(model)  # load onnx model
    onnx.checker.check_model(model_onnx)  # check onnx model

    model_onnx, check = onnxsim.simplify(model_onnx)
    assert check, "assert check failed"
    onnx.save(model_onnx, model)

    print(f"Model exported to {model}")
